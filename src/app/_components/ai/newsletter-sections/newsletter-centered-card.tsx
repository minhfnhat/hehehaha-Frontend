    ...
    <div className={`py-16 sm:py-24`}>
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Subscribe to our newsletter for delicious recipes, exclusive discounts, and early access to new food products. Stay informed and enjoy the culinary journey with us.
          </p>
